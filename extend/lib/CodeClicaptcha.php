...
class CodeClicaptcha
{
    ...
    {
        $APP_PATH     = str_replace("application", "public", APP_PATH);
        $img1         = $APP_PATH.'static'.DS.'admin'.DS.'images'.DS.'code_bg1.jpg';
        $img2         = $APP_PATH.'static'.DS.'admin'.DS.'images'.DS.'code_bg2.jpg';
        $img3         = $APP_PATH.'static'.DS.'admin'.DS.'images'.DS.'code_bg3.jpg';
        $font         = $APP_PATH.'static'.DS.'admin'.DS.'images'.DS.'SourceHanSansCN-Normal.otf';
