...
class Common extends Controller
{
    ...
    {
        if (Request::module() == 'admin' && Request::controller() == 'Index' && in_array(Request::action(),
                ['login', 'init', 'index'])) {
            return true;
        }
        ...
        if (strpos(Request::action(), 'public_') === 0) {
            return true;
        }
        $r = Db::name('admin_role_priv')->where(array('m'      => Request::module(),
    ...
    {
        if (Request::action() == '' || Request::action() == 'index' || strpos(Request::action(),
                '_list') || in_array(Request::action(), array('login', 'public_home'))) {
            return false;
        } else {
